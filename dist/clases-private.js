...
class Picture {
    constructor(id, title, orientation) {
        //Propiedades
        _Picture_id.set(this, void 0); //a partir de ts 3.8 se puede poner '#' como private
...
class Album {
    constructor(id, title) {
        ...
        __classPrivateFieldSet(this, _Album_pictures, [], "f"); //inicializamos para que la estructura este lista para recibir objetos mas adelantes
    }
    addPicture(picture) {
        __classPrivateFieldGet(this, _Album_pictures, "f").push(picture); //accediendo a la propiedad pictures
    }
}
